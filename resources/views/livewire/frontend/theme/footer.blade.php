<footer class="footer ">
                ...
                <div class="row gy-5 gx-4">
                    <div class="col-md-6">
                        <div class="footer__about">
                            <a href="index-2.html" class="footer__about-logo"><img src="{{ url('assets/frontend/images/logo/logo-dark.png') }}"
                                    alt="Logo"></a>
    ...
    <div class="footer__shape">
        <span class="footer__shape-item footer__shape-item--1"><img src="{{ url('assets/frontend/images/footer/1.png') }}"
                alt="shape icon"></span>
